      ...
      <div className="mt-6 grid grid-cols-1 gap-6">
        ...
        <div className="p-6 bg-white border border-slate-200 rounded-lg">
          ...
          <div className="flex gap-3 flex-wrap">
            <a href="/dashboard/student/check-in" className="px-4 py-2 bg-[#800000] text-white rounded hover:bg-[#600000] transition-colors text-sm font-medium">
              New Wellness Check-In
            </a>
            <a href="/dashboard/student" className="px-4 py-2 bg-slate-100 text-slate-900 rounded hover:bg-slate-200 transition-colors text-sm font-medium">
              View My Progress
            </a>
          </div>
        </div>
